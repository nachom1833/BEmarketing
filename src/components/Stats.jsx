...
const STATS_DATA = [
  { value:120, suffix:'+', labelES:'Proyectos ejecutados', labelEN:'Projects executed', descES:'con impacto medible', descEN:'with measurable impact' },
  { value:11,  suffix:'+', labelES:'Años de experiencia',  labelEN:'Years of experience', descES:'en mercados globales', descEN:'in global markets' },
